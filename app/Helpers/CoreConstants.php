...
class CoreConstants
{
    ...
    const PORTFOLIO_CONFIG__VISIBILITY_PUBLICATION = 9;
    const PORTFOLIO_CONFIG__VISIBILITY_PROJECT = 10;
    const PORTFOLIO_CONFIG__VISIBILITY_SERVICE = 11;
    const PORTFOLIO_CONFIG__VISIBILITY_CONTACT = 12;
    const PORTFOLIO_CONFIG__VISIBILITY_FOOTER = 13;

    const PORTFOLIO_CONFIG__SCRIPT_HEADER = 14;
    const PORTFOLIO_CONFIG__SCRIPT_FOOTER = 15;

    const PORTFOLIO_CONFIG__META_TITLE = 16;
    const PORTFOLIO_CONFIG__META_AUTHOR = 17;
    const PORTFOLIO_CONFIG__META_DESCRIPTION = 18;
    const PORTFOLIO_CONFIG__META_IMAGE = 19;

    const PORTFOLIO_CONFIG__VISIBILITY_CV = 20;
    const PORTFOLIO_CONFIG__VISIBILITY_SKILL_PROFICIENCY = 21;
