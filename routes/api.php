...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['throttle:30,1']], function () {
        ...
        Route::group(['middleware' => ['jwt.verify']], function () {
            ...
            Route::get('/publications', ['App\Http\Controllers\Admin\Api\PublicationController', 'index']);
            Route::post('/publications', ['App\Http\Controllers\Admin\Api\PublicationController', 'store']);
            Route::get('/publications/{id}', ['App\Http\Controllers\Admin\Api\PublicationController', 'show']);
            Route::put('/publications/{id}', ['App\Http\Controllers\Admin\Api\PublicationController', 'update']);
            Route::delete('/publications', ['App\Http\Controllers\Admin\Api\PublicationController', 'destroy']);
