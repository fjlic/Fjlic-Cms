...
const Dashboard = () => {
        ...
        useEffect(() => {
            setColors({
                ...
                publication: Utils.randomHexColor(),
            ...
            if (demoMode) {
                notification.open({
                    message: ( <
                        ...
                        a target = "_blank"
                        rel = "noreferrer"
                        href = "https://github.com/arifszn/ezfolio" >
                        <
                        img src = "https://img.shields.io/github/stars/arifszn/ezfolio?style=social"
                        alt = "Github Star" / >
                        <
                        /a> < /
                        div >
                    ...
                    <
                    div className = "text-center" >
                    Show your❤️ and support by giving a⭐️ on < a target = "_blank"
                    rel = "noreferrer"
                    href = "https://github.com/arifszn/ezfolio" > GitHub < /a>. < /
                    div > <
                    div className = "text-center" >
                    <
                    a href = { Routes.web.frontend.home }
                    target = "_blank"
                    rel = "noreferrer" > Visit Front Panel < /a> < /
                    div > <
                    /Space> < /
                    React.Fragment > ,
        ...
        return ( <
                ...
                <
                StatCard link = { Routes.web.admin.portfolioSkills }
                loading = { loading }
                icon = { < Icon component = { GoKeyboard }
                    ...
                    icon = { < Icon component = { GiSecretBook }
                        ...
                        icon = { < Icon component = { BsBriefcase }
                            ...
                            <
                            StatCard
                            link = { Routes.web.admin.portfolioPublications }
                            loading = { loading }
                            icon = { < Icon component = { BiArchive }
                                />}
                                color = { colors.publication }
                                title = 'Publication'
                                number = { publicationData.total }
                                /> < /
                                Col > <
                                /Row> < /
                                Col > <
                                ...
                                icon = { < Icon component = { BiArchive }
                                    ...
                                    icon = { < Icon component = { RiServiceLine }
                                        ...
                                        xs = { 24 }
                                        style = {
                                            { textAlign: 'center', paddingBottom: '14px' }
                                        } >
                                        <
                                                                ...
                                                                icon = { < Icon component = { RiMessage3Line }
                                                                    ...
                                                                    icon = { < Icon component = { RiMessage3Line }
                                                                        ...
                                                                        cover = { <
                                                                            ...
                                                                            <
                                                                            Card.Meta
                                                                            title = { < React.Fragment > < small > Daily Wallpaper {
                                                                                    demoMode && ( <
                                                                                        a href = "https://github.com/arifszn/reddit-image-fetcher"
                                                                                        target = "_blank"
                                                                                        rel = "noreferrer" > < InfoCircleOutlined style = {
                                                                                            { paddingLeft: '2px', color: 'rgba(0, 0, 0, 0.45)' }
                                                                                        }
                                                                                        /></a >
                                                                                    )
                                                                            ...
                                                                            description = { <
                                                                                div onClick = { getWallpaper }
                                                                                style = {
                                                                                    { cursor: 'pointer' }
                                                                                } > < small > Get Another < /small></div >
                                                                            }
                                                                            /> < /
                                                                            Card > <
                                                                            /Col> < /
