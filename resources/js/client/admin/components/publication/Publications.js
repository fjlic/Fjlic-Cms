...
const Publications = () => {
    ...
    const showConfirm = (rows) => {
        ...
        confirm({
            ...
            onOk() {
                setLoading(true);
                HTTP.delete(Routes.api.admin.publications, {
                    params: {
                        ids: ids
                    }
                })
    ...
    return (
        <React.Fragment>
                ...
                <PageHeader
                    ...
                    subTitle={
                        <Typography.Text
                            ...
                            ellipsis={{ tooltip: 'Your publications to showcase' }}
                        >
                            Your publications to showcase
                        </Typography.Text>
                    }
                    extra={[
                ...
                >
                    <ProTable
                        ...
                        request={async (params, sorter) => {
                            return HTTP.get(Routes.api.admin.publications+'?page='+params.current, {
                                params: {
                                    params,
                                    sorter,
                                    columns
            ...
            </PageWrapper>
            {
                modalVisible && (
                    <Publication
                        title={itemToEdit ? 'Edit Publication' : 'Add Publication'}
