        ...
        >
            <Spin spinning={componentLoading} size="large" delay={500}>
                ...
                <Row>
                    <Col span={24}>
                        <Carousel autoplay pauseOnHover={false}>
                            {
                                JSON.parse(props.publication.images).map((image, index) => (
                                    <div key={index}>
                                        <Image
                ...
                <Row>
                    <Col span={24}>
                        {
                            JSON.parse(props.publication.categories).map((category, index) => (
                ...
                {
                    (props.publication.details !== null) && props.publication.details !== '' && (
                        <React.Fragment>
                            <Divider/>
                            <StyledTitle>Description</StyledTitle>
                            <Row>
                                <Col span={24}>
                                    {props.publication.details}
                                </Col>
                            </Row>
                        </React.Fragment>
                    )
                ...
                {
                    props.publication.link && props.publication.link !== '' && (
                        <React.Fragment>
                            <Divider/>
                            <StyledTitle>Link</StyledTitle>
                            <Row>
                                <Col span={24}>
                                    <a href={props.publication.link} target="_blank" rel="noreferrer">
